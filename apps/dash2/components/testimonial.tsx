  ...
  return (
    <div className="relative mt-10 lg:mt-0 flex size-full flex-col items-center justify-center overflow-hidden rounded-lg  pb-5  mb-1x0">
      <div className="mx-auto flex max-w-full flex-col items-center space-y-4 pt-0 text-center">
        <h2 className="mx-0  text-balance bg-gradient-to-br from-black from-30% to-black/60 bg-clip-text  text-4xl font-semibold leading-none tracking-tighter text-transparent dark:from-white dark:to-white/40 sm:text-3xl md:text-5xl lg:text-5xl px-2">
