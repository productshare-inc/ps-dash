...
import {  Home, Inbox,AppWindowIcon } from "lucide-react"
...
export const CONNECTIONS: ConnectionCardProps[] = [
    {
      ...
      oauthUrl: `https://api.notion.com/v1/oauth/authorize?client_id=${process.env.NOTION_CLIENT_ID}&redirect_uri=${process.env.NEXT_PUBLIC_URL}/api/callback/notion&response_type=code&owner=user`,
      published: true,
      showModal: false
    },
    {
